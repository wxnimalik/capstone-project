...
<head>
    ...
    <title>Event Insight | Meeting Calendar</title>
    ...
    <div class="container">
        <div class="navigation">
				<ul>
					...
					<li>
						<a href="/syncmastercalendar/dashboard.php">
    ...
    <script>
        $(document).ready(function () {
            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                events: 'fetchmeeting.php', // PHP script to fetch events from the database
            });
        ...
        function goBack() {
            window.location.href = 'meetinganalysis.php';
        }
        </script>
